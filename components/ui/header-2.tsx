...
export function Header() {
    ...
    return (
        <header
            className={cn(
                'sticky top-0 z-50 mx-auto w-full max-w-5xl border-b border-transparent text-foreground md:rounded-md md:border md:transition-all md:ease-out',
                {
            ...
            <div className="container mx-auto">
                ...
                >
                    ...
                    <div className="hidden items-center gap-2 md:flex">
                        {links.map((link, i) => (
                            <a key={i} className={buttonVariants({ variant: 'ghost' })} href={link.href} onClick={() => setOpen(false)}>
                                {link.label}
                            </a>
                        ))}
